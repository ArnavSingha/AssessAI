...
import { Loader2, Eye, EyeOff, CheckCircle2, XCircle, ChevronLeft } from 'lucide-react';
...
export function IntervieweeAuth() {
  ...
  const handleAuth = async (
    ...
    try {
      ...
      toast({
        ...
        description: `Redirecting you to the interviewee section...`,
      });
    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-8rem)]">
      <Tabs defaultValue="signin" className="w-full max-w-md">
        ...
        <TabsContent value="signin">
          <Card>
            <CardHeader>
              <CardTitle>Interviewee Sign In</CardTitle>
              <CardDescription>Access your interview session.</CardDescription>
            </CardHeader>
            <CardContent>
              <form
              ...
              >
                <div className="space-y-2">
                  <Label htmlFor="email-signin-interviewee">Email</Label>
                  <Input
                    id="email-signin-interviewee"
                    name="email"
                    type="email"
                ...
                <div className="space-y-2">
                  <Label htmlFor="password-signin-interviewee">Password</Label>
                  <div className="relative">
                    <Input
                      id="password-signin-interviewee"
                      name="password"
        ...
        <TabsContent value="signup">
          <Card>
            <CardHeader>
              <CardTitle>Interviewee Sign Up</CardTitle>
              <CardDescription>
            ...
            <CardContent>
              ...
              >
                <div className="space-y-2">
                  <Label htmlFor="name-signup-interviewee">Name</Label>
                  <Input
                    id="name-signup-interviewee"
                    name="name"
                    type="text"
                ...
                <div className="space-y-2">
                  <Label htmlFor="email-signup-interviewee">Email</Label>
                  <Input
                    id="email-signup-interviewee"
                    name="email"
                    type="email"
                    placeholder="m@example.com"
                    required
                ...
                <div className="space-y-2">
                  <Label htmlFor="password-signup-interviewee">Password</Label>
                  <div className="relative">
                    <Input
                      id="password-signup-interviewee"
                      name="password"
                      type={showPassword ? 'text' : 'password'}
                      required
                ...
                <div className="space-y-2">
                  <Label htmlFor="confirmPassword-signup-interviewee">
                    Confirm Password
                  </Label>
                  <div className="relative">
                    <Input
                      id="confirmPassword-signup-interviewee"
